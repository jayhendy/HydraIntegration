...
public class SixenseInputTest : MonoBehaviour
{
	...
	void Update()
	{
		...
		if ( guiText )
		{
			guiText.GetComponent<UnityEngine.UI.Text>().text = "Base Connected = " + SixenseInput.IsBaseConnected( 0 );
		}
		...
		for ( uint i = 0; i < 2; i++ )
		{
			if ( SixenseInput.Controllers[i] != null )
			{
				...
				if ( guiText )
				{
					guiText.GetComponent<UnityEngine.UI.Text>().text = "Enabled = " + SixenseInput.Controllers[i].Enabled;
				}
				
				guiText = GameObject.Find( "gui_text_controller_" + controllerNumber + "_docked" );
				if ( guiText )
				{
					guiText.GetComponent<UnityEngine.UI.Text>().text = "Docked = ";
					if ( SixenseInput.Controllers[i].Enabled )
					{
						guiText.GetComponent<UnityEngine.UI.Text>().text += SixenseInput.Controllers[i].Docked;
					}
				}
				...
				if ( guiText )
				{
					guiText.GetComponent<UnityEngine.UI.Text>().text = "Hand = ";
					if ( SixenseInput.Controllers[i].Enabled )
					{
						guiText.GetComponent<UnityEngine.UI.Text>().text += SixenseInput.Controllers[i].Hand;
					}
				}
				...
				if ( guiText && guiText2 )
				{
					...
					guiText.GetComponent<UnityEngine.UI.Text>().text = "Buttons = " + buttonsText;
					guiText2.GetComponent<UnityEngine.UI.Text>().text = "" + buttonsText2;
				}
				
				guiText = GameObject.Find( "gui_text_controller_" + controllerNumber + "_trigger" );
				if ( guiText )
				{
					guiText.GetComponent<UnityEngine.UI.Text>().text = "Trigger = ";
					if ( SixenseInput.Controllers[i].Enabled )
					{
						guiText.GetComponent<UnityEngine.UI.Text>().text += SixenseInput.Controllers[i].Trigger;
					}
				}
				...
				if ( guiText )
				{
					guiText.GetComponent<UnityEngine.UI.Text>().text = "Joystick X = ";
					if ( SixenseInput.Controllers[i].Enabled )
					{
						guiText.GetComponent<UnityEngine.UI.Text>().text += SixenseInput.Controllers[i].JoystickX;
					}
				}
				...
				if ( guiText )
				{
					guiText.GetComponent<UnityEngine.UI.Text>().text = "Joystick Y = ";
					if ( SixenseInput.Controllers[i].Enabled )
					{
						guiText.GetComponent<UnityEngine.UI.Text>().text += SixenseInput.Controllers[i].JoystickY;
					}
				}
				...
				if ( guiText )
				{
					guiText.GetComponent<UnityEngine.UI.Text>().text = "Position = ";
					if ( SixenseInput.Controllers[i].Enabled )
					{
						guiText.GetComponent<UnityEngine.UI.Text>().text += SixenseInput.Controllers[i].Position;
					}
				}
				...
				if ( guiText )
				{
					guiText.GetComponent<UnityEngine.UI.Text>().text = "Rotation = ";
					if ( SixenseInput.Controllers[i].Enabled )
					{
						guiText.GetComponent<UnityEngine.UI.Text>().text += SixenseInput.Controllers[i].Rotation;
					}
				}
			}
		}
